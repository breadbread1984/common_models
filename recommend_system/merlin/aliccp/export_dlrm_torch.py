...
def add_options():
  ...
  flags.DEFINE_string('output', default = 'dlrm_model_torch', help = 'path to exported model')
...
def main(unused_argv):
  ...
  scripted_model = model.to_torchscript(method = "trace", example_inputs = example_inputs)
